...
### [Задача №765. Частоты появления элементов](https://informatics.msk.ru/mod/statements/view.php?id=599&chapterid=765#1)
...
[Решение python](./topic_3/task_765_value_counts.py) _Пройдены не все тесты! Превышено максимальное время работы._